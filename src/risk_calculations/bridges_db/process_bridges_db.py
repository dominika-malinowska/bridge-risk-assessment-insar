...
from ps_predictions.second_paper.risk_calculation.structural_vulnerability_assessment import (
    get_vulnerability,
)
from ps_predictions.second_paper.bridges_db.retrieve_osm_lines_for_brdgs import (
    find_OSM_lines_and_polygons,
)
from ps_predictions.second_paper.risk_calculation.exposure_assessment import (
    get_exposure,
)
...
if __name__ == "__main__":
    ...
    data_path = os.path.join("/mnt/g/RISK_PAPER", "lsb_bridges_database")
    lsb_path = os.path.join(data_path, "LSB Database_corrected.csv")

    # Define the output paths
    output_path = os.path.join(data_path, "lsb_OSM_polygons_03032025.shp")
    output_path_lines = os.path.join(data_path, "lsb_OSM_lines_03032025.shp")
    output_path_lines_csv = os.path.join(data_path, "lsb_OSM_lines_03032025.csv")
